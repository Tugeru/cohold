...
export function CreateProposalModal({
  ...
  return (
    <div ref={dialogRef} role="dialog" aria-modal="true" aria-label={`Create spending proposal in ${treasury.name}`} tabIndex={-1} className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 p-4 backdrop-blur-sm animate-in fade-in">
